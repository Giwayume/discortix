<template>
    <div class="my-16 mx-auto max-w-174">
        <section class="px-3 py-2">
            <div class="mb-6">
                <h2 class="text-2xl leading-6 font-normal mb-1 text-strong">{{ t('userSettings.encryption.identityHeading') }}</h2>
                <p class="text-sm text-subtle">{{ t('userSettings.encryption.identityDescription') }}</p>
            </div>
        ...
        <section class="px-3 py-2">
            <div class="mb-6">
                <h2 class="text-2xl leading-6 font-normal mb-1 text-strong">{{ t('userSettings.encryption.roomKeysHeading') }}</h2>
                <p class="text-sm text-subtle">{{ t('userSettings.encryption.roomKeysDescription') }}</p>
            </div>
        ...
        <section class="px-3 py-2">
            <div class="mb-6">
                <h2 class="text-2xl leading-6 font-normal mb-1 text-strong">{{ t('userSettings.encryption.deviceKeysHeading') }}</h2>
                <p class="text-sm text-subtle">{{ t('userSettings.encryption.deviceKeysDescription') }}</p>
            </div>
            ...
            <div v-else-if="currentDeviceHasKeys" class="flex gap-2 items-center">
                <span class="pi pi-check-circle text-feedback-positive" aria-hidden="true" />
        ...
        <section class="px-3 py-2">
            <div class="mb-6">
                <h2 class="text-2xl leading-6 font-normal mb-1 text-strong">{{ t('userSettings.encryption.warningsHeader') }}</h2>
            </div>
